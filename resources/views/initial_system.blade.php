...
@section('content')
        ...
        <div class="row">
            <div class="col">
                <div class="alert alert-info alert-dismissible text-center">
                    Add System by clicking the "Add System" Button. You'll then be able to add Sensors/Devices to these Systems. This will help you better manage devices.
                    You can skip this step by clicking the "Next Step" Button below.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <h4 class="text-center"><span class="badge badge-pill badge-success">2</span></h4>
            </div>
        </div>
    ...
    <!--</div>-->
        ...
        <br />
        <p class="text-center"><a href="{{ route('initial_user') }}" class="btn btn-sm badge-pill badge-success">Next Step</a></p>
